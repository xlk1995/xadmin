...
<template>
  ...
  >
    <div
      class="flex flex-row w-full flex-1 h-14 items-center dark:bg-transparent bg-gray-900 text-white"
    >
      <div
        ...
        <li>
          <a
            ...
            ><span
              ...
              ><i class="i-mdi-television"></i></span
            ><span class="grow font-bold text-white">Dashboard</span>
          </a>
        </li>
      </ul>
